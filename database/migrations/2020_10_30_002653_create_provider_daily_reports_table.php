...
class CreateProviderDailyReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('provider_daily_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('provider_daily_reports');
    }
}
