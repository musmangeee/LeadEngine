...
class CreateBuyerChannelDailyReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('buyer_channel_daily_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('buyer_channel_daily_reports');
    }
}
